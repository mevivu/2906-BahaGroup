						...
						<div class="col-md-7 mb-5 mt-5">
							...
							@if (!isset($productModal->productVariations[0]))
								<p class="lead">
									...
									<strong class="text-red">{{ format_price($productModal->promotion_price) }}</strong><br>
								...
								<div class="row mt-3">
									<div class="col-md-3">
										<div class="input-group mt-2">
											<button disabled id="btnDecrementModal" class="btn btn-default" type="button"
												onclick="decrementDetail()">-</button>
											<input readonly onblur="isEnoughQuantity(this)" id="filter-input-detail-modal"
												class="form-control text-center" value="1" min="1">
											<button disabled id="btnIncrementModal" class="btn btn-default" type="button"
				...
				<div class="modal-content">
					...
					<div class="modal-body row">
						...
						<div class="col-md-7">
							...
							<div class="row mt-1">
								<a class="col-2 bg-red custom-col btn btn-sm square-btn color-btn-modal mb-2 h-16 w-16"></a>
								<a
							...
							<div class="row mt-1">
								<a class="col-2 custom-col btn btn-sm square-btn capacity-btn-modal out-of-stock mb-2 w-5">
