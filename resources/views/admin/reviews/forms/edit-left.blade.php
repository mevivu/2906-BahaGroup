      ...
      <div class="col-12">
        <div class="mb-3">
          ...
          <x-select name="user_id" id="user_id" class="select2-bs5-ajax"
            ...
            <x-select-option :option="$instance->user_id" :value="$instance->user_id"
              :title="$instance->user->fullname" />
          </x-select>
        </div>
        <div class="mb-3">
          ...
          <x-select name="product_id" id="product_id" class="select2-bs5-ajax"
            ...
            <x-select-option :option="$instance->product_id" :value="$instance->product_id"
              :title="$instance->product->name . ' - ' . $instance->product->price" />
          </x-select>
        </div>
        ...
        <div class="mb-3">
          ...
          <x-textarea name="content" class="form-control" :required="true">{{ $instance->content }}</x-textarea>
        </div>
