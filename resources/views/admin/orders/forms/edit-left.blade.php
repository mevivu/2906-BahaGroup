								...
								<div class="row card-body">
												...
												<div class="col-12 col-md-6">
																...
																<div id="infoShipping">
																				...
																				@else
																								@include('admin.orders.partials.info-shipping-no-login')
																				@endif
																</div>
																<div class="mb-3">
																...
																<div class="mb-3">
																				...
																				<x-select name="order[district_id]" id="district_id" class="select2-bs5-ajax"
																...
																<div class="mb-3">
																				...
																				<x-select name="order[ward_id]" id="ward_id" class="select2-bs5-ajax"
