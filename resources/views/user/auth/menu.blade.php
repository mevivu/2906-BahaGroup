<div class="col-md-2 col-12 mb-2">
				<ul class="list-group">
								<li class="list-group-item {{ Route::is('user.order.indexUser') ? 'bg-default text-white' : '' }}"><i
																class="fa fa-shopping-cart me-2 ms-2"></i><x-link
																class="{{ Route::is('user.order.indexUser') ? 'text-white' : 'text-6' }}" :href="route('user.order.indexUser')">ĐƠN
																HÀNG</x-link></li>
