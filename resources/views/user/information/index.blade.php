    ...
    <div class="banner-information"
        ...
        <div style="width: 80%;" class="row mb-5 flex-section margin-information justify-content-between">
            <div class="col-4 col-md-12 col-12 bg-white mb-3 shadow">
                ...
                <i
                    class="{{ $settingsInformation->where('setting_key', 'infor_card_icon_1')->first()->plain_value }} info-icon ms-3 me-3"></i>
                <h4 class="ms-3 me-3 mt-3">
            ...
            <div class="col-4 col-md-12 col-12 bg-white mb-3 shadow">
                <div style="margin-top: 2rem;"></div>
                <i
                    class="{{ $settingsInformation->where('setting_key', 'infor_card_icon_2')->first()->plain_value }} info-icon ms-3 me-3"></i>
                <h4 class="ms-3 me-3 mt-3">
            ...
            <div class="col-4 col-md-12 col-12 bg-white mb-3 shadow">
                <div style="margin-top: 2rem;"></div>
                <i
                    class="{{ $settingsInformation->where('setting_key', 'infor_card_icon_3')->first()->plain_value }} info-icon ms-3 me-3"></i>
                <h4 class="ms-3 me-3 mt-3">
