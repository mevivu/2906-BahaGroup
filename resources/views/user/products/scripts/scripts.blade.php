<script>
        ...
        `);
																				...
																				$('.category-checkbox:checked, input[name="color_slugs[]"]:checked, input[name="size_slugs[]"]:checked')
																								.each(function() {
																												let slug = $(this).val();
																												let name = $(this).next('label').text() || $(this).closest('label').find('.checkmark')
																																.attr(
																																				'title');
																								...
																								$.ajax({
																												...
																												success: function(response) {
																																...
																																if (response.data.qty == 0) {
																																				...
																																				$('input[name="hidden_product_variation_id"]').val(response
																																								.data
																																								.id);
												...
												const sort = document.getElementById('sort'); sort.addEventListener('change', function() {
