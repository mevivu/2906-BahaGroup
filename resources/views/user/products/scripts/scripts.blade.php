				...
				function showDetailProductModal(modal, product_id) {
								...
								$.ajax({
												...
												success: function(res) {
																...
																$('#quickViewProductModal1 #badge-promotion-percent').text(Math.round(100 - res.product
																				.promotion_price / res.product.price * 100) + '%')
																$('#quickViewProductModal1 #product_name_modal').text(res.product.name);
																$('#quickViewProductModal1 #price_modal').text((res.product.price).toLocaleString('vi-VN', {
																				style: 'currency',
																				currency: 'VND'
																}));
																$('#quickViewProductModal1 #promotion_price_modal').text((res.product.promotion_price)
																				.toLocaleString('vi-VN', {
																								style: 'currency',
																								currency: 'VND'
																				}));
																$('#quickViewProductModal1 #quantity_product_modal').text(res.product.qty == 0 ? 'Hết Hàng' :
																				`Còn ${res.product.qty} Hàng`);
																if (res.avgReviewRate != 0) {
																				...
																				$('#quickViewProductModal1 .rating').append(
																								`<span> ${res.sumCustomerReview} khách hàng đánh giá</span>
