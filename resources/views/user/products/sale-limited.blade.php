                ...
                <div class="col-12">
                        ...
                        <div class="col-6 col-md-3 mb-4">
                            <div class="card border-0 hover-shadow">
                                <div class="position-relative">
                                    ...
                                    <img onclick="location.href='{{ route('user.product.detail', ['id' => $item->product->id]) }}';" class="card-img-top img-hover" src="{{ asset($item->product->gallery[0]) }}" alt="{{ $item->product->name }}" style="display: none;cursor: pointer;">
                    ...
                    <div id="pagination" class="pagination">
                        ...
                        @php
                            ...
                            $end = $paginator->currentPage + 2 <= $paginator->totalPages ? $paginator->currentPage + 2 : $paginator->totalPages;
                        @endphp
                        @for ($i = $start; $i <= $end; $i++)
                        <button class="pagination-btn {{ $i == $paginator->currentPage ? 'active' : '' }}" data-page="{{ $i }}">{{ $i }}</button>
                        @endfor
                        @if ($paginator->totalPages > 1)
...
@include('user.products.scripts.pagination-scripts')
