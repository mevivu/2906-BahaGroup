																								...
																								<div class="row">
																												<div class="col-md-12">
																																...
																																<div class="row me-3 mt-2">
																																				<a class="col-2 bg-red custom-col btn btn-sm square-btn color-btn mb-2 h-16 w-16"></a>
																																				<a
																																								class="col-2 bg-yellow custom-col btn btn-sm square-btn color-btn mb-2 h-16 w-16"></a>
																																				<a class="col-2 bg-green custom-col btn btn-sm square-btn color-btn mb-2 h-16 w-16"></a>
																																				<a class="col-2 bg-pink custom-col btn btn-sm square-btn color-btn mb-2 h-16 w-16"></a>
																																				<a
																																								class="col-2 custom-col btn btn-sm square-btn color-btn out-of-stock mb-2 h-16 w-16 bg-black"></a>
																																				<a
																																								class="col-2 bg-cyan custom-col btn btn-sm square-btn color-btn out-of-stock mb-2 h-16 w-16"></a>
																																</div>
																												</div>
																								</div>
																								<div class="row">
																												<div class="col-md-12">
																																...
																																<div class="row me-3 mt-2">
																																				<a class="col-2 custom-col btn btn-sm square-btn capacity-btn out-of-stock mb-2 w-5">
																																								<p class="me-2 ms-2 mt-3">128GB</p>
																																				</a>
																																				<a class="col-2 custom-col btn btn-sm square-btn capacity-btn mb-2 w-5">
