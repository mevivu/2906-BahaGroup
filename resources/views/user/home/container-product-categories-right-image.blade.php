...
<div id="product-category-right-image" class="container">
    <div class="row">
        <div class="col-12 header-box d-flex align-items-center">
            <h4>Quần áo thời trang</h4>
        </div>

        <div class="col-12 col-xl-9">
            <nav>
                <div class="nav nav-tabs" id="nav-tab-2" role="tablist">
                    <button class="nav-link" id="nav-toy-tab" data-bs-toggle="tab" data-bs-target="#nav-toy"
                        type="button" role="tab" aria-controls="nav-toy" aria-selected="false">Babies & Toys</button>
                    <button class="nav-link" id="nav-accessory-tab" data-bs-toggle="tab" data-bs-target="#nav-accessory"
                        type="button" role="tab" aria-controls="nav-accessory" aria-selected="false">Phụ kiện điện
                        tử</button>
                    <button class="nav-link active" id="nav-cloth-tab" data-bs-toggle="tab" data-bs-target="#nav-cloth"
                        type="button" role="tab" aria-controls="nav-cloth" aria-selected="true">Fashion &
                        Clothing</button>
                    <button class="nav-link" onclick="location.href='category.php';"
                        type="button" role="tab" aria-controls="nav-home" aria-selected="true">Tất cả</button>
                </div>
            </nav>
            <div class="tab-content" id="nav-tabContent-2">
                <div class="tab-pane fade show active" id="nav-cloth" role="tabpanel" aria-labelledby="nav-cloth-tab">
                    <div id="productCarousel-4" class="carousel slide">
                        ...
                        <button class="carousel-control-next right-btn-slider1" type="button" data-bs-target="#productCarousel-4"
                            data-bs-slide="next">
                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
                <div class="tab-pane fade" id="nav-accessory" role="tabpanel" aria-labelledby="nav-accessory-tab">
                    <div id="productCarousel-5" class="carousel slide">
                        ...
                        <button class="carousel-control-next right-btn-slider1" type="button" data-bs-target="#productCarousel-5"
                            data-bs-slide="next">
                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
                <div class="tab-pane fade" id="nav-toy" role="tabpanel" aria-labelledby="nav-toy-tab">
                    <div id="productCarousel-6" class="carousel slide">
                        ...
                        <button class="carousel-control-next right-btn-slider1" type="button" data-bs-target="#productCarousel-6"
                            data-bs-slide="next">
                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                        </button>
                    </div>
        ...
        <div class="col-3 d-none d-lg-block">
            <a href="#" class="banner-img">
                <img loading="lazy" decoding="async" width="240" height="433" src="{{ asset('public/user/assets/images/banner-home2-04.jpg') }}"
                    class="d-none d-xl-inline-block" alt=""> </a>
        </div>
    </div>
</div>
