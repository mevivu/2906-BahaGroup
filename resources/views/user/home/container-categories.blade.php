								...
								@foreach ($categories as $category)
												<div class="col-6 col-md-2 text-center">
																<div class="rounded-3 shadow-sm">
																				<x-link :href="route('user.product.indexUser', ['category_ids[]' => $category->id])">
																								<div class="product_avt">
																												<img src="{{ asset($category->avatar) }}" width="100%" />
																								</div>
																				</x-link>
																				<p>
																								<x-link :href="route('user.product.indexUser', ['category_ids[]' => $category->id])" class="fs-6 text-dark">
																												{{ $category->name }}
																								</x-link>
																				</p>
																</div>
