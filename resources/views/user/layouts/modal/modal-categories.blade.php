<div class="row container container-fluid p-0 absolute-category">
    <div style="margin-left: -16px;" id="side-bar" class="col-3 {{ Route::currentRouteName() != 'user.index' ? 'd-none' : '' }}">
        <ul class="menu">
            ...
            <li><a href="#"><i class="ti ti-headphones"></i>Accessories <i class="ti ti-chevron-right"></i></a>
                <div class="submenu mega-menu">
                    <div class="mega-column">
                        <h3>Phụ kiện di động</h3>
                        <ul>
            ...
            <li><a href="#"><i class="ti ti-tools-kitchen"></i>Home & Kitchen <i class="ti ti-chevron-right"></i></a>
                <div class="submenu mega-menu">
                    <div class="mega-column">
                        <h3>Phụ kiện di động</h3>
                        <ul>
