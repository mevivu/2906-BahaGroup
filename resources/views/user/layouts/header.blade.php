    ...
    <div class="container">
        <div class="row pt-3 pb-3">
            ...
            <div class="col-6 d-flex justify-content-center align-items-center">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control dropdown-toggle"
                        placeholder="Nhập từ khóa bạn muốn tìm kiếm..." id="searchInput"
                        aria-label="Text input with dropdown button" data-bs-toggle="dropdown" aria-expanded="false">
                    <ul class="dropdown-menu w-75" id="searchResults">
                        <li class="dropdown-item disabled">Nhập kết quả tìm kiếm</li>
                    </ul>
            ...
            <div class="col-3 d-flex justify-content-center align-items-center">
                @if (!auth('web')->user())
                    <div class="me-5 pe-"><a class="top-item text-black" href="{{ route('user.auth.indexUser') }}">Đăng
                            nhập</a></div>
                @else
