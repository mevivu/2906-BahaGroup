						...
						@foreach ($shoppingCart as $item)
							...
							: ($item->product->on_flash_sale
								...
								: format_price($item->product->promotion_price * $item->qty)) }}
												...
												<td class="delete-cell align-middle" style="font-size: 1.5em;"><i data-id="{{ $item->id }}"
														style="cursor: pointer" onclick="removeCart(this)"
														class="ti ti-trash-x text-danger"></i></td>
											</tr>
						@endforeach
					</tbody>
				</table>
